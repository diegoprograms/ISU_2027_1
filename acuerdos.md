...
- La tarea actual es redactar el anteproyecto.
- Se utilizará Git desde la redacción para conservar los avances en los archivos.
- Cada docente podrá trabajar conversando con Codex y aportar al repositorio compartido.
- El usuario aprobó la estructura descrita en README.md y autorizó su creación local.
